...
module Cha
  module API
    ...
    # @option params [Array<Symbol>] :status (nil)
    ...
    # @param room_id [Integer] ID of chat room
    # @param params [Hash] Hash of optional parameter
    # @option params [Integer] :account_id (nil) Account ID of task person in charge
    # @option params [Integer] :assigned_by_account_id (nil) Account ID of task client
    # @option params [Symbol] :status (nil) Task status (open, done)
    # @return [Hashie::Mash]
    ...
    # @param params [Hash] Hash of optional parameter
    # @option params [Integer] :limit (nil) Deadline of task (unix time)
    # @return [Hashie::Mash]
    ...
    # @param params [Hash] Hash of optional parameter
    # @option params [Boolean] :create_download_url (nil) Create URL for download
